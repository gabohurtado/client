                    ...
                    <form className="col-md-9" onSubmit={this.handleSubmit}>
                        <div className="">
                            <div className="col-md-12">
                                <input type="text" className="form-control" placeholder="Nunca dejes de buscar" autoFocus />
                            </div>
                        </div>
                    </form>
                </nav>
...
export default connect(mapStateToProps, { fetchProducts })(NavbarComponent)